        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:max-w-none lg:grid-cols-2 lg:items-center mb-20">
            ...
            >
               ...
               <div className="mb-8 flex items-center gap-6">
                 <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-white/5 p-3 ring-1 ring-white/10 backdrop-blur-sm shadow-2xl">
                    <Image src="/ITBP_Logo.png" alt="ITBP Logo" width={80} height={80} className="object-contain h-full w-full" />
                 </div>
