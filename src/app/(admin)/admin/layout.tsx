  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex">
      ...
      <div className="md:hidden fixed top-0 w-full bg-gray-900/90 backdrop-blur z-30 border-b border-gray-800 p-4 flex justify-between items-center">
         <h1 className="text-lg font-bold bg-linear-to-r from-indigo-400 to-fuchsia-400 bg-clip-text text-transparent">Sparkz Admin</h1>
            ...
            <>
                ...
                >
                    <div className="p-6 border-b border-gray-800 flex justify-between items-center">
                        <span className="text-xl font-bold bg-linear-to-r from-indigo-400 to-fuchsia-400 bg-clip-text text-transparent">Sparkz Admin</span>
